...
pub(crate) mod parsers {
    ...
    mod tests {
        ...
        fn data_test() {
            ...
            let f =
                parse_data_buffer::<f32, BigEndian>("3 32 32.0 4e3".as_bytes(), 4, FileType::ASCII);
            assert_eq!(
                f,
                Ok((
                    "".as_bytes(),
            ...
            let f =
                parse_data_buffer::<f64, BigEndian>("3 32 32.0 4e3".as_bytes(), 4, FileType::ASCII);
            assert_eq!(
                f,
                Ok((
                    "".as_bytes(),
